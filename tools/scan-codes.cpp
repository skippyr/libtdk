...
#define BOOLEAN_STATE(value) (value ? "\x1b[32menabled\x1b[39m" : "\x1b[31mdisabled\x1b[39m")

static void WriteHelpPage()
{
    std::cout << "\x1b[1mUsage:\x1b[22m \x1b[32mscan-codes "
...
int main(int totalArguments, const char** arguments)
{
    ...
    for (int offset = 0; offset < totalArguments; ++offset)
    {
        ...
        {
            std::cerr << "\x1b[1;31m[ERROR]\x1b[22;39m Use of unrecognized flag \x1b[33m" << arguments[offset]
                      << "\x1b[39m." << std::endl
